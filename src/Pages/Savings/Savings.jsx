...
const Savings = () => {
  ...
  return (
    <div>
      <div>
        <p className="text-4xl sm:text-3xl lg:text-4xl font-bold text-center">
          Get Up To 70% Off
        </p>
      </div>

      {/* Responsive grid */}
      <div className="savings-articles pt-10 lg:pt-20 grid grid-cols-2 md:grid-cols-4 gap-5 2xl:px-20">
        {Data.map((item) => (
          <article
            key={item.id}
            style={{
            ...
            className="w-full"
          >
            <div className="article-preview px-5 py-2 md:py-5">
              <h3 className="font-extrabold text-xl sm:text-2xl text-red-950">
                Save
              </h3>
              <h2 className=" py-2 md:py-4">
                <span>
                  <sup className="text-2xl sm:text-3xl font-bold">
                    <sup>$ &#x20;</sup>
                  </sup>
                </span>
                <span className="text-2xl md:text-4xl sm:text-5xl font-bold">
                  {item.amount}
                </span>
              </h2>
              <p className="text:xs md:text-base  text-gray-500 font-extralight md:font-normal md:tracking-wide">
                {item.details}
              </p>
            </div>
            <figure>
